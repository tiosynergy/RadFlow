...
const DETAIL_KEYS: readonly string[] = [
  ...
  // с77: вивантаження пошуку в Excel (`patient_data.exported`) — скільки записів
  // ЦЬОГО центру пішло у файл, звідки і в якому форматі. Без них заголовок
  // «(записів: N)» не доїжджав би до картки (ревʼю с77, A-6).
  "rows", "source", "format",
];
