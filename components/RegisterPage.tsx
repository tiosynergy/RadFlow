...
async function registerUser(values: RegValues): Promise<RegisterResult> {
...
export default function RegisterPage() {
  ...
  function showToast(message: string, type = "error", title?: string) {
  ...
  async function onSubmit(e: FormEvent) {
    ...
    if (res.field === "email") {
      ...
      showToast(res.message || "Помилка");
    }
  }

  const inputProps = (name: string, type = "text", extra: InputHTMLAttributes<HTMLInputElement> = {}) => ({
    id: name,
    type,
