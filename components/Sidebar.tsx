...
export default function Sidebar({
  ...
  /* Лічильник листа очікування (RLS сам обмежує видимість клінікою користувача).
     ...
     ⚠️ Що лишається і чому це все-таки борг: без фільтра сюди прилітає ФАКТ і
     ЧАС кожного видалення рядка листа в УСІЙ базі — крос-тенантний оракул
     ідентифікаторів. Закривається фільтром `clinic_id=eq.`, але клініки в
     пропах сайдбара сьогодні немає, а тягнути її через усі сторінки заради
     LOW — окремий пакет (U-65). */
