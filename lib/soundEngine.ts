...
/* ===== RadFlow — Web Audio движок звукових сповіщень =====
   Рівно ДВА семантичні звуки на весь продукт (рішення власника, не розширювати
   без доведеної операційної потреби):
     • playPatientReady()      — спокійний подвійний сигнал (~330 мс);
