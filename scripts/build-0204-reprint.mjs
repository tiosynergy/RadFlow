...
const PROBES = [
  ...
  fakeMark("v_admin", "v_clinic", "queue_entry", "v_q", "studies"),
  fakeMark("v_admin", "v_clinic", "waitlist_entry", "v_w", "studies"),
  fakeMark("v_admin", "v_clinic", "patient_case", "v_c", "studies"),
  "  if v_ref2 is not null then",
  indent(fakeMark("v_ref2", "v_clinic", "queue_entry", "v_q", "studies")),
  indent(fakeMark("v_ref2", "v_clinic", "waitlist_entry", "v_w", "studies")),
  indent(fakeMark("v_ref2", "v_clinic", "patient_case", "v_c", "studies")),
  "  end if;",
