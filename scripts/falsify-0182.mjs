...
const MUTATIONS = [
  ...
  },
  {
    ...
    what: "коментар у шапці міграції переписано",
    from: "--  RF-02 (серпневий аудит), НАЗВАНИЙ ХВІСТ: «токен запрошення без TTL».",
    to: "--  RF-02 (серпневий аудит), названий хвіст: «токен запрошення без TTL».",
  },
];
