...
const MUTATIONS = [
  ...
  },
  {
    ...
    from: 'export const N8N_FREE_COMMANDS = ["run", "room", "cas", "waitlist", "midnight"];',
    to: 'export const N8N_FREE_COMMANDS = ["run", "room", "cas", "waitlist", "midnight", "stop"];',
  },
  {
...
const EXPECTED_RED = 58;   // +M17..M23 зупинка, +M24..M28 розблокування «кейса» (с63), +M29..M35 «північ» (пакет 56), +M36..M42 `stop --with-case` (пакет 61), +M43..M45 гард токена (правка живого прогону 11.09), +M46..M47 вакуум усередині вирішального упорядкування (пакет 62), +M48..M57 гард доставки: n8n-гілка (с65, друга редакція після двох ревʼю), +M58 перша мутація в CLI
