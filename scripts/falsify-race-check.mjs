...
const EXPECTED_RED = 47;   // +M17..M23 зупинка, +M24..M28 розблокування «кейса» (с63), +M29..M35 «північ» (пакет 56), +M36..M42 `stop --with-case` (пакет 61), +M43..M45 гард токена (правка живого прогону 11.09), +M46..M47 вакуум усередині вирішального упорядкування (пакет 62)
