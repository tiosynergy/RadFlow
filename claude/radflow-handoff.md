...
**Обновлено: 2026-08-25 ~13:15 UTC (16:15 Kiev), конец сессии 42.**

Прод-БД на `0158`, ledger 158, все md5, `invariants_check()` → `ok:true
checked:11`. Следующая миграция — `0159`.

`main` = `70274c6`, `dev` = `25f744f` — **совпадают по содержимому, дерево
чистое, хвостов нет.** Всё, что делалось в с41–с42 (0156, 0157, 0158, P1
ReferralPortal, stale/transition, P2 outbox, live-check со сверкой,
fmtOrigin → lib, мёртвые navKey), влито.
...
Тулчейн на `main`: tsc 0, eslint 0, **vitest 1130/1130 (46 файлов)**,
build OK, deploy-гейт 158/158.
