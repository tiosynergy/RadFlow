...
--     (126449 Б -> 129854 Б) не пересилається, БД редагує своє власне
...
alter function public.audit_log_retention(p_pii_days integer, p_meta_days integer, p_limit integer) set search_path = public, pg_temp;
alter function public.audit_log_retention_daily() set search_path = public, pg_temp;
alter function public.auth_can_refer(c uuid) set search_path = public, pg_temp;
alter function public.auth_ceo_clinics() set search_path = public, pg_temp;
alter function public.auth_clinic_id() set search_path = public, pg_temp;
alter function public.auth_is_ceo_of(c uuid) set search_path = public, pg_temp;
alter function public.auth_is_referrer() set search_path = public, pg_temp;
alter function public.auth_referrer_clinics() set search_path = public, pg_temp;
alter function public.ceo_list_for_clinic(p_clinic uuid) set search_path = public, pg_temp;
alter function public.check_case_distinct_room() set search_path = public, pg_temp;
alter function public.check_case_no_time_overlap() set search_path = public, pg_temp;
alter function public.check_service_room_override() set search_path = public, pg_temp;
alter function public.clinic_deletion_execute(p_request uuid, p_token text) set search_path = public, pg_temp;
alter function public.delete_clinic_member(target uuid) set search_path = public, pg_temp;
alter function public.event_outbox_retention(p_delivered_days integer, p_pii_days integer, p_dead_days integer, p_limit integer) set search_path = public, pg_temp;
alter function public.fn_audit() set search_path = public, pg_temp;
alter function public.gcal_connection_secret_cleanup() set search_path = public, pg_temp;
alter function public.gcal_secret_delete(p_id uuid) set search_path = public, pg_temp;
alter function public.gcal_secret_get(p_id uuid) set search_path = public, pg_temp;
alter function public.gcal_secret_store(p_secret text, p_description text) set search_path = public, pg_temp;
alter function public.gcal_secret_update(p_id uuid, p_secret text) set search_path = public, pg_temp;
alter function public.guard_call_status_change() set search_path = public, pg_temp;
alter function public.guard_priority_change() set search_path = public, pg_temp;
alter function public.guard_referrer_doctor() set search_path = public, pg_temp;
alter function public.guard_status_change_referrer() set search_path = public, pg_temp;
alter function public.guard_waitlist_room() set search_path = public, pg_temp;
alter function public.mark_changes_seen(p_ids uuid[]) set search_path = public, pg_temp;
alter function public.outbox_retention_daily() set search_path = public, pg_temp;
alter function public.rl_check(p_key text, p_max integer, p_window_seconds integer) set search_path = public, pg_temp;
alter function public.search_cities(q text) set search_path = public, pg_temp;
alter function public.search_clinics(q text) set search_path = public, pg_temp;
alter function public.search_referrers(q text) set search_path = public, pg_temp;
alter function public.sink_overdue_scheduled() set search_path = public, pg_temp;
alter function public.sink_overdue_scheduled_all() set search_path = public, pg_temp;
