...
--      чотири базиси: витяг тіла 0192 дає 58f496e7efa1a502dde4b6621fe3c2ae / 118522;
...
--        -- очікування: 0a036d5f097fba3a11ca39c0c9885d93 / 120547
...
--      (64cc243f5bc52c7a157bd3c610e9ff69 і cc2c999dff6ad82b9a8687443fad64ba), тіло сторожа — до 0192
--      (58f496e7efa1a502dde4b6621fe3c2ae / 118522), рядок леджера знімається.
...
--      шукати `0a036d5f097fba3a11ca39c0c9885d93`, `236114e0ed2c52a4ddbecb939d6ee65e`,
--      `6206620abcd6386ba00fa5f4091aaca1` у `claude/*` і `docs/audit/*`. ЗАМІРЯНО 14.09
--      пошуком по всьому репозиторію: усі згадки цих трьох md5 і довжини
--      `120547` лежать РІВНО у пʼятьох файлах самого пакета, які
