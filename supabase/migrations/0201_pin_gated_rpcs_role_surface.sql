...
--  Даних НЕ чіпає. `checked` 25 -> 26. Список №19: 43 -> 59. Ключів №26: 62.
...
--      помилка DRYRUN_0201_ROLLBACK з checked=26 і failed лише `ledger_md5`.
...
--      guard_md5 = f0134c6203dacab659fd85648c5e9aa9, guard_len = 164374, ledger_rows = 201.
...
begin
  ...
  --        0193 → 40, 0200 → 43, 0201 → 59), а заголовок ніхто не перечитував: 0192 оновила
...
comment on function public.invariants_check(boolean) is 'guard_body_md5=f0134c6203dacab659fd85648c5e9aa9;len=164374';
...
--     (00146b182c9a366094678ccdb10f35aa / 140268), САМОПІН повертається до 0200,
...
--     (`node scripts/bump-checked-pins.mjs 26 25` + `docs/ops-cron.md`), повернути
