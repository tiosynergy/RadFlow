...
--  сторож рахує 12 перевірок (0159)».
--
-- ДВА РЕЖИМИ ЗАПУСКУ:
...
--   (j) invariants_check(false): checked = 12 (0159), room_busy_service_role мовчить;
...
begin
  ...
  -- (j) сторож: 12 перевірок (0159), room_busy_service_role мовчить.
