...
begin
  ...
  -- b: перевірок рівно 22 (0156: 10, 0157: 11, 0159: +outbox_rows_overdue)
  ...
  if (v_base ->> 'checked')::int is distinct from 22 then
    raise exception 'SMOKE_FAIL b: checked=% (очікував 22)', v_base ->> 'checked';
  end if;
  v_done := v_done || ' b';
