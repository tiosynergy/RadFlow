...
2. **Владелец коммитит пакет сессии 12** (~30 файлов + доки; тулчейн: **276/276**).
   В пакет входит и упрощённый перенос: `RescheduleModal.tsx`, `BookingModal.tsx`,
   `CaseModal.tsx`, `lib/useModalA11y.ts` (файлы уже положены в `D:\RadFlowDev`).
...
5. **🎯 «Вимкнути кабінет» замість видалення — міграція 0123 (утверждено владельцем).**
