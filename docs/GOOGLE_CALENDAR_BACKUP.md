...
- У Google Calendar створити ОКРЕМИЙ календар «RadFlow Backup — <Клініка>»
  ...
  календар, куди акаунт має право писати, — RadFlow не обмежує вибір і не
  ділить календарі на «особисті» й «робочі» (рішення власника, с43).
  Окремий календар радимо тому, що в копії живуть ПІБ і телефони пацієнтів,
  а для аварійного читання календар доводиться відкривати персоналу.
...
- **Вибір календаря не обмежений** (рішення власника, с43): підійде будь-який
  календар, куди акаунт має право писати. RadFlow не ділить календарі на
  «особисті» й «робочі» — підключений календар стає робочим.
