...
## Чинні задачі (звірено з продом 2026-08-24; +gcal-backup-sync із 0161)
...
| `invariants` | `50 3 * * *` | `select public.invariants_check()` — сторож інваріантів (13 перевірок з `0161`), слід у `maintenance_runs` | міграція `0154`–`0161` |
