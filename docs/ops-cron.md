...
| `invariants` | `50 3 * * *` | `select public.invariants_check()` — сторож інваріантів (**25 перевірок** з `0198`), слід у `maintenance_runs` | міграція `0154`–`0198` |
...
доки хтось не виконає запит вище руками. Тобто **23 перевірки сьогодні
