...
**Дата:** 2026-07-28 (сессия 14) · **Ветка:** `dev`. Незакоммичено — **пакет сессии 14, 43 файла**
(редактирование карточки персонала + перевод типографики на rem). Коммитит владелец.
