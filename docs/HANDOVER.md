...
**Дата:** 2026-07-14 · **Ветка:** `dev` · **PROD:** БД на **`0075`** (0061–0075 применены владельцем). Следующая новая миграция = **0076**. Код `main` ещё старый — мердж `dev → main` разблокирован.
...
### 5.1. ✅ Миграции применены (по 0075, 2026-07-14) — мердж разблокирован

Прод-БД на **`0075`**. Осталось смерджить `dev → main` (деплой миграции **не** гоняет). Следующая новая миграция = **0076**.
