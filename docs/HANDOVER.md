...
**Дата:** 2026-07-26 (сессия 10, финал) · **Ветка:** `dev`, HEAD `6d7bb74`, дерево ЧИСТОЕ.
...
`6d7bb74`; Vercel-автодеплой прошёл, прод отдаёт `/login`). `origin/main..dev` теперь пусто (⚠️ локальный
