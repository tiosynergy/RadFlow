...
**Дата:** 2026-07-18 · **Ветка:** `dev` · **PROD:** БД на **`0105`** (0061–0105 применены владельцем, ledger `supabase_migrations` пуст — накатка ручная через SQL Editor). Следующая новая = **0106**.
