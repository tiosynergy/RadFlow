...
**Дата:** 2026-07-14 · **Ветка:** `dev` · **PROD:** БД на **`0076`** (0061–0076 применены владельцем). Следующая новая = **0077**.
...
### 5.1. ✅ Миграции применены (по 0076, 2026-07-14) — мердж разблокирован

Прод-БД на **`0076`**. Осталось смерджить `dev → main` (деплой миграции **не** гоняет). Следующая новая = **0077**.
