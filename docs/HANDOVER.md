...
**Дата:** 2026-07-15 · **Ветка:** `dev` · **PROD:** БД на **`0088`** (0061–0088 применены владельцем). ⚠️ **0089 и 0090 написаны/закоммичены, НЕ применены** — накатить вручную по порядку. Следующая новая = **0091**.
