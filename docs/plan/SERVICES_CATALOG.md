...
**Обновлено:** 2026-07-18 · **Статус:** фазы 0–1 реализованы; этот документ — полная
структура автоматизации/интеграции и план реализации фаз 2–4.

## 0. Решения владельца (зафиксированы 2026-07-18)

1. Каталог — **per-clinic** (свой прайс у каждого центра).
2. Оверрайд на уровне **кабинета — только ВРЕМЯ** исследования (цена и состав —
   на уровне центра): старый аппарат медленнее, новый быстрее.
...
5. При создании кабинета — **автосид** перечня услуг + дефолтного времени
   для его модальности (если каталог модальности ещё пуст).
