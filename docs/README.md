...
> Доступность — внедрён UX-аудит P0/P1/P2 + аудит Нільсена v2 (WCAG 2.1 AA, см. §4.12 в PRODUCT_OVERVIEW).
...
- **[`audit/AUDIT-SUMMARY-2026-09-22.md`](audit/AUDIT-SUMMARY-2026-09-22.md)** — результаты аудита
  одной страницей вместо 267 КБ журнала: вердикт **CONDITIONAL GO** (18.09.2026), четыре условия
  выхода (П-1, П-2, П-3, П-6), диспозиция фаз 0–8, что открыто, принятые риски, ключевые замеры
  и состояние прода, сверенное запросом. Список предпродакшена — [`audit/ToDo_Production.md`](audit/ToDo_Production.md).
