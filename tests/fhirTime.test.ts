...
describe("Europe/Kiev — історичний алias тієї самої зони", () => {
  /* До 0202 (17.09.2026) на проді у clinics.timezone було записано
     «Europe/Kiev» (старе написання); тепер там «Europe/Kyiv», а CHECK аліас
     уже не пропускає. Тест лишається: аліас і далі може прийти з браузера
     (старий ICU, див. lib/tzCanonical.ts) і з історичних даних. Це один і той
     самий запис IANA, але покладатись на це мовчки не можна: якби Node на якомусь стенді знав лише одне з написань,
